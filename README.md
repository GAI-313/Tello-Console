...
## サンプルコードを使って学習する
　Tello-Console には標準でサンプルコードがいくつか用意されています。サンプルコードは、アップデートにつれて順次増やす予定です。サンプルコードでは Tello-Console の基本的な使い方を学ぶことができるので、ぜひご活用ください。サンプルコードを使った学習は。他のサイトで公開予定です。
